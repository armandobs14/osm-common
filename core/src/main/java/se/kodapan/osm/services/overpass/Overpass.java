...
public class Overpass extends HttpService {
    ...
    /**
     * 2013-07-28 Usage policy accept 10 000 requests or 5GB data per day using
     * up to two threads. See
     * http://wiki.openstreetmap.org/wiki/Overpass_API#Introduction
     *
     * @param overpassQuery a query to be sended to overpass
     * @param queryDescription a query description
     * @return a return ov overpass
     * @throws se.kodapan.osm.services.overpass.OverpassException a exception throwed whether can't execute the request 
     */
