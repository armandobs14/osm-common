...
public class PojoRoot extends AbstractRoot implements Serializable {
     ...
     * @return a collection of OsmObjects
     * @see Collection
     */
    ...
    /**
     * @param input a collection of OsmObjects
     * @param filter returns true if instance is to be removed from results
     * @return a collection of OsmObjects
     * @see Collection
     */
    ...
    /**
     * todo this loop get really slow where there is hundreds of thousands of
     * coordinates and as many calls to the method... index? todo if an index
     * then it needs to be up to date when node values change. that requires
     * keeping track of root from osmobjects.... todo and what if the object is
     * added to multiple roots then? todo so an index is probably not possible.
